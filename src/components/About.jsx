      ...
      <div className="dark min-h-screen">
        <div className="font-display bg-background-light dark:bg-background-dark text-slate-900 dark:text-white antialiased overflow-x-hidden">
          <div className="relative flex min-h-screen w-full flex-col">
            {/* Header */}
           {/* Header - Matching Home Component */}
    ...
    >
      <span className="truncate">Get a Quote</span>
                ...
                <div className="layout-content-container flex flex-col max-w-[960px] flex-1 w-full">
                  <div className="@container">
                    <div className="@[480px]:p-4">
                      <div 
                        className="relative flex min-h-[400px] sm:min-h-[480px] flex-col gap-6 overflow-hidden rounded-xl bg-cover bg-center bg-no-repeat @[480px]:gap-8 items-center justify-center p-6 sm:p-8 text-center"
                        style={{
                      ...
                      >
                        <div className="flex flex-col gap-4 max-w-2xl z-10">
                          <h1 className="text-white text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black leading-tight tracking-[-0.033em] animate-fade-in-up">
                            Forging Entrances,<br/> <span className="text-primary">Defining Homes</span>
                          </h1>
                        ...
                        <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 z-10 mt-4">
                          <Link 
                            to="/Portfolio"
                            className="flex min-w-[120px] cursor-pointer items-center justify-center overflow-hidden rounded-full h-11 sm:h-12 px-5 sm:px-6 bg-primary text-[#112218] text-sm sm:text-base font-bold leading-normal tracking-[0.015em] hover:scale-105 transition-transform"
                          >
            ...
            <div className="layout-container flex flex-col items-center">
              <div className="layout-content-container flex flex-col w-full max-w-[960px] px-4 sm:px-6 lg:px-10 xl:px-20">
            ...
            {/* Timeline */}
            <div className="layout-container flex flex-col items-center pb-12">
              <div className="layout-content-container flex flex-col w-full max-w-[960px] px-4 sm:px-6 lg:px-10 xl:px-20">
                <div className="grid grid-cols-[32px_1fr] sm:grid-cols-[40px_1fr] gap-x-4 sm:gap-x-6 px-4">
                  ...
                  <div className="flex flex-col items-center gap-1 pt-3">
                    ...
                    <div className="w-[2px] bg-gradient-to-b from-primary/50 to-transparent h-full grow min-h-[60px]"></div>
                  </div>
                  ...
                  <div className="flex flex-col items-center gap-1">
                    <div className="w-[2px] bg-gradient-to-b from-transparent via-primary/50 to-primary/50 h-full min-h-[20px]"></div>
                    <div className="text-primary bg-primary/10 rounded-full p-1">
            ...
            <div className="bg-surface-dark py-12 sm:py-16 md:py-24">
              <div className="layout-container flex flex-col items-center">
                <div className="layout-content-container flex flex-col w-full max-w-[1100px] px-4 sm:px-6 lg:px-10 gap-12 sm:gap-16 md:gap-24">
                    ...
                    <div className="w-full md:w-1/2">
                      <div className="relative overflow-hidden rounded-xl sm:rounded-2xl shadow-2xl aspect-[4/3] group">
                        ...
                        <div className="absolute bottom-3 sm:bottom-4 left-3 sm:left-4">
                          <span className="bg-primary text-[#112218] text-xs font-bold px-2 sm:px-3 py-1 rounded-full uppercase tracking-wider">Step 01</span>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="w-full md:w-1/2">
                      <div className="relative overflow-hidden rounded-xl sm:rounded-2xl shadow-2xl aspect-[4/3] group">
                        ...
                        <div className="absolute bottom-3 sm:bottom-4 right-3 sm:right-4">
                          <span className="bg-primary text-[#112218] text-xs font-bold px-2 sm:px-3 py-1 rounded-full uppercase tracking-wider">Step 02</span>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="flex flex-col md:flex-row items-center gap-6 sm:gap-8 md:gap-16">
                    <div className="w-full md:w-1/2">
                      <div className="relative overflow-hidden rounded-xl sm:rounded-2xl shadow-2xl aspect-[4/3] group">
                        ...
                        <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent"></div>
                        <div className="absolute bottom-3 sm:bottom-4 left-3 sm:left-4">
                          <span className="bg-primary text-[#112218] text-xs font-bold px-2 sm:px-3 py-1 rounded-full uppercase tracking-wider">Step 03</span>
                        </div>
                      </div>
                    </div>
                    <div className="w-full md:w-1/2 flex flex-col gap-3 sm:gap-4">
                      <h3 className="text-white text-xl sm:text-2xl font-bold flex items-center gap-3">
                        <span className="material-symbols-outlined text-primary">door_sliding</span>
                        Installation & Finish
                      </h3>
                      <p className="text-gray-300 leading-relaxed text-sm sm:text-base">
            ...
            {/* Core Values Grid */}
            <div className="layout-container flex flex-col items-center py-12 sm:py-16 md:py-20">
              <div className="layout-content-container flex flex-col w-full max-w-[960px] px-4 sm:px-6 lg:px-10">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
                  {/* Value 1 */}
                  <div className="bg-surface-dark p-4 sm:p-6 rounded-xl sm:rounded-2xl border border-white/5 hover:border-primary/50 transition-colors group">
                    <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-background-dark flex items-center justify-center mb-3 sm:mb-4 group-hover:bg-primary group-hover:text-[#112218] transition-colors text-primary">
            ...
            >
              <div className="layout-container flex flex-col items-center">
                <div className="layout-content-container flex flex-col w-full max-w-[800px] px-4 sm:px-6 text-center">
                  <span className="material-symbols-outlined text-primary text-4xl sm:text-5xl md:text-6xl mb-4 sm:mb-6 opacity-50">format_quote</span>
                  ...
                  <div className="flex items-center justify-center gap-3 sm:gap-4">
                    ...
                    <div className="text-left">
                      ...
                      <p className="text-primary text-xs sm:text-sm">Austin, TX</p>
                    </div>
                  </div>
