      ...
      <style dangerouslySetInnerHTML={{
        __html: `
          ...
          @theme {
            ...
            --color-accent-dark: #112218;
            --color-surface-dark: #1c3226;
...
<header className="flex items-center justify-between whitespace-nowrap border-b border-solid border-gray-200 dark:border-[#234832] px-4 sm:px-6 lg:px-10 py-3 sm:py-4 bg-background-light dark:bg-[#112218] z-50 sticky top-0">
      ...
      <span className="truncate">Get a Quote</span>
            ...
            <main className="flex-1">
              ...
              <section className="relative">
                <div className="w-full mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 lg:py-20 flex flex-col items-center justify-center min-h-[400px] sm:min-h-[500px] lg:min-h-[600px] relative overflow-hidden rounded-none lg:rounded-b-[3rem]">
                  ...
                  <div className="relative z-10 flex flex-col gap-4 sm:gap-6 text-center max-w-4xl mx-auto animate-fade-in-up">
                    ...
                    <div className="pt-4 flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center">
                      <button 
                        onClick={openModal}
                        className="flex h-11 sm:h-12 items-center justify-center rounded-full bg-primary px-6 sm:px-8 text-[#112218] text-sm sm:text-base font-bold transition hover:bg-[#25cc68]"
                      >
                        Start Your Project
                      </button>
                ...
                <div className="mx-auto max-w-7xl">
                  ...
                  <div className="columns-1 sm:columns-2 lg:columns-3 gap-4 sm:gap-6 space-y-4 sm:space-y-6">
                    ...
                    {[
                      ...
                      <div key={index} className="break-inside-avoid group relative overflow-hidden rounded-xl sm:rounded-2xl bg-surface-dark cursor-pointer">
                        ...
                        <div className="absolute bottom-0 left-0 w-full p-4 sm:p-6 translate-y-2 group-hover:translate-y-0 transition-transform duration-300">
                          <div className="flex items-start justify-between">
                            <div>
                              <p className="text-primary text-xs font-bold uppercase tracking-wider mb-1">{item.category}</p>
              ...
              <section className="relative bg-background-dark py-12 sm:py-16 lg:py-20 overflow-hidden">
                <div className="absolute inset-0 bg-[#0c1811]"></div>
                <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                  <div className="flex flex-col lg:flex-row gap-8 sm:gap-12 items-center">
                    <div className="w-full lg:w-1/2 relative">
                      ...
                      {/* Floating Badge */}
                      <div className="absolute -bottom-4 -right-4 sm:-bottom-6 sm:-right-6 hidden md:flex h-24 sm:h-28 md:h-32 w-24 sm:w-28 md:w-32 items-center justify-center rounded-full bg-primary p-3 sm:p-4 text-center shadow-lg">
                    ...
                    <div className="w-full lg:w-1/2 text-left">
                      <div className="flex items-center gap-2 mb-3 sm:mb-4">
                        ...
                        <span className="text-primary text-xs sm:text-sm font-bold uppercase tracking-widest">Uncompromising Quality</span>
                      </div>
  ...
  <li><Link to="/faq" className="hover:text-primary transition-colors">FAQ</Link></li>
            ...
            <button 
              onClick={openModal}
              className="fixed bottom-6 right-6 z-50 flex md:hidden size-12 sm:size-14 items-center justify-center rounded-full bg-primary text-[#112218] shadow-2xl hover:scale-110 transition-transform"
            >
