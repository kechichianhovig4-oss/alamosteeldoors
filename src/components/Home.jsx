...
const Home = () => {
  ...
  return (
    <div className="dark min-h-screen bg-[#112218] font-display text-gray-100">
      {/* Font imports */}
      ...
      <div className="relative flex w-full flex-col bg-[#112218]">
          ...
          <div className="flex items-center justify-between px-4 sm:px-6 lg:px-10 py-3 sm:py-4">
            ...
            <div className="hidden md:flex items-center gap-4 lg:gap-6">
              <Link 
                to="/" 
                onClick={() => handleNavClick('/')}
                className="text-sm font-medium leading-normal text-primary hover:text-green-400 transition-colors px-3 py-2"
              >
                Home
              </Link>
              <Link 
                ...
                className="text-sm font-medium leading-normal hover:text-primary transition-colors px-3 py-2"
              >
                Portfolio
              </Link>
              <Link 
              ...
              <button 
                onClick={openModal}
                className="flex min-w-[100px] cursor-pointer items-center justify-center overflow-hidden rounded-full h-10 px-5 bg-primary text-[#112218] text-sm font-bold leading-normal tracking-[0.015em] hover:bg-green-400 transition-all hover:shadow-[0_0_15px_rgba(43,238,121,0.5)] ml-2"
              >
                Get a Quote
              </button>
            </div>
            ...
            <div className="md:hidden bg-[#112218] border-t border-[#234832] shadow-lg">
              <div className="px-4 py-4 space-y-1">
                <Link 
                  to="/" 
                  onClick={() => handleNavClick('/')}
                  className="block px-4 py-3 text-primary text-sm font-medium leading-normal hover:text-green-400 transition-colors"
                >
                  Home
                </Link>
                <Link 
        ...
        <main className="flex-1 bg-[#112218]">
          {/* Hero Section */}
          <div className="relative w-full overflow-hidden min-h-[85vh] flex items-center justify-center bg-[#112218]">
            ...
            <div className="absolute inset-0 z-0 bg-gradient-to-b from-transparent via-[#112218]/70 to-[#112218]"></div>
            ...
            <div className="relative z-10 w-full max-w-[1280px] mx-auto px-4 sm:px-6 py-16 sm:py-24 text-center">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-primary/30 bg-primary/10 backdrop-blur-sm mb-4 sm:mb-6">
          ...
          {/* Portfolio Section */}
          <div className="w-full py-16 sm:py-24 max-w-[1280px] mx-auto px-4 sm:px-6 bg-[#112218]">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 mb-8 sm:mb-12">
              ...
              <div>
                ...
                <ul className="space-y-1.5 sm:space-y-2 text-xs sm:text-sm text-gray-400">
                  <li><Link to="/About" onClick={() => handleNavClick('/About')} className="hover:text-primary transition-colors">About Us</Link></li>
                  <li><Link to="/Contact" onClick={() => handleNavClick('/Contact')} className="hover:text-primary transition-colors">Contact</Link></li>
                  <li><Link to="/faq" onClick={() => handleNavClick('/faq')} className="hover:text-primary transition-colors">FAQ</Link></li>
                </ul>
              </div>
